...
export class TestRequestLinkedListController {
  ...
  @ApiQueries(["locale"])
  @ApiCreatedResponse({ type: TestRequestDto })
  ...
  @ApiParam({
    name: "from",
    type: "string",
    description: "_id of testrequest to switch",
  })
  @ApiParam({
    name: "to",
    type: "string",
