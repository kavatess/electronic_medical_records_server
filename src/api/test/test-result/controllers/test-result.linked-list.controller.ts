...
export class TestResultLinkedListController {
  ...
  @ApiQueries(["locale"])
  @ApiCreatedResponse({ type: TestResultDto })
  ...
  @ApiParam({
    name: "from",
    type: "string",
    description: "_id of testresult to switch",
  })
  @ApiParam({
    name: "to",
    type: "string",
