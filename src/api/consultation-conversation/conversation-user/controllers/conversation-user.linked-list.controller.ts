...
export class ConversationUserLinkedListController {
  ...
  @ApiQueries(["locale"])
  @ApiCreatedResponse({ type: ConversationUserDto })
  ...
  @ApiParam({
    name: "from",
    type: "string",
    description: "_id of conversationuser to switch",
  })
  @ApiParam({
    name: "to",
    type: "string",
