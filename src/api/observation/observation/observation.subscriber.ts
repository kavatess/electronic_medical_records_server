...
export class ObservationSubscriber {
  ...
  @RabbitSubscribe({
    ...
    queue: "consultation-server.observation.subscriber.created",
    queueOptions: {
      exclusive: false,
      durable: true,
      autoDelete: true,
  ...
  @RabbitSubscribe({
    exchange: "ResourceEvent",
    routingKey: "*.*.Observation.updated",
    queue: "consultation-server.observation.subscriber.updated",
    queueOptions: {
      exclusive: false,
      durable: true,
      autoDelete: true,
  ...
  @RabbitSubscribe({
    exchange: "ResourceEvent",
    routingKey: "*.*.Observation.deleted",
    queue: "consultation-server.observation.subscriber.deleted",
    queueOptions: {
      exclusive: false,
      durable: true,
      autoDelete: true,
