...
export class PatientNoteLinkedListController {
  ...
  @ApiQueries(["locale"])
  @ApiCreatedResponse({ type: PatientNoteDto })
  ...
  @ApiParam({
    name: "from",
    type: "string",
    description: "_id of patientnote to switch",
  })
  @ApiParam({
    name: "to",
    type: "string",
