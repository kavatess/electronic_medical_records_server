...
@Injectable()
export class PrescriptionSubscriber {
  constructor(
  ...
  @RabbitSubscribe({
    ...
    routingKey: "*.*.Prescription.created",
    queue: "consultation-server.prescription.subscriber.created",
    queueOptions: {
      exclusive: false,
      durable: true,
      autoDelete: true,
  ...
  @RabbitSubscribe({
    exchange: "ResourceEvent",
    routingKey: "*.*.Prescription.updated",
    queue: "consultation-server.prescription.subscriber.updated",
    queueOptions: {
      exclusive: false,
      durable: true,
      autoDelete: true,
  ...
  @RabbitSubscribe({
    exchange: "ResourceEvent",
    routingKey: "*.*.Prescription.deleted",
    queue: "consultation-server.prescription.subscriber.deleted",
    queueOptions: {
      exclusive: false,
      durable: true,
      autoDelete: true,
