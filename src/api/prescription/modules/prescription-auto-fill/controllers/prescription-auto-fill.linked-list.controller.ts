...
@ApiTags("prescriptionautofill-linked-list")
@UseGuards(AuthenticatedHeaderGuard, PoliciesGuard)
@ApiSecurity("ApiKeyAuth", ["token"])
@Controller("prescriptionautofill")
export class PrescriptionAutoFillLinkedListController {
  constructor(private readonly service: PrescriptionAutoFillService) {}
  ...
  @ApiQueries(["locale"])
  @ApiCreatedResponse({ type: PrescriptionAutoFillDto })
  ...
  @ApiParam({
    name: "from",
    type: "string",
    description: "_id of prescriptionautofill to switch",
  })
  @ApiParam({
    name: "to",
    type: "string",
